#' @importFrom stats var sd cor median rnorm acf aggregate lm coef pf setNames start end approx ave fitted na.pass optim pnorm quantile residuals time as.formula predict lm.fit qt
...
utils::globalVariables(c(
  ...
  # ggplot2 aes variables for visualization functions
